package me.ChewyN.Util;
/*
Credit to SirSpoodles on Spigotmc.org
https://www.spigotmc.org/threads/free-code-sending-perfectly-centered-chat-message.95872/
Code seen below may have been edited slightly
*/
...
public class Message {
    ...
    //Edit by ChewyN to broadcast centered messages
    ...
    public static void sendCenteredMessage(Server server, String message){
        ...
        server.broadcastMessage(sb.toString() + message);
    }
